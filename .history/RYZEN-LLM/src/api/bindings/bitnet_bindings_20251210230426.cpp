...
extern "C" {
    ...
    __declspec(dllexport) int test_create_quant_config() {
        try {
            std::cout << "DEBUG: test_create_quant_config called" << std::endl;
            ryzen_llm::bitnet::QuantConfig config;
            std::cout << "DEBUG: QuantConfig created successfully" << std::endl;
            return 1;
        } catch (const std::exception& e) {
            std::cout << "DEBUG: Exception creating QuantConfig: " << e.what() << std::endl;
            return -1;
        } catch (...) {
            std::cout << "DEBUG: Unknown exception creating QuantConfig" << std::endl;
            return -2;
        }
    }
    ...
    __declspec(dllexport) int test_scalar_quantize_direct() {
        try {
            ...
            std::cout << "DEBUG: Weight quantization completed" << std::endl;
            ...
            std::cout << "DEBUG: Activation quantization completed" << std::endl;
