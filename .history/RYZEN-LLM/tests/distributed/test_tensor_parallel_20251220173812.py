...
class TestRowParallelLinear:
    ...
    def test_gradient_flow(self, mock_communicator):
        ...
        layer = RowParallelLinear(in_features, out_features, mock_communicator)
    ...
    def test_output_matching_baseline(self, mock_communicator):
        ...
        parallel_layer = RowParallelLinear(in_features, out_features, mock_communicator)
...
class TestParallelAttention:
    ...
    def test_initialization(self, mock_communicator):
        ...
        attention = ParallelAttention(embed_dim, num_heads, mock_communicator)
...
class TestParallelMLP:
    ...
    def test_initialization(self, mock_communicator):
        ...
        mlp = ParallelMLP(embed_dim, hidden_dim, mock_communicator)
