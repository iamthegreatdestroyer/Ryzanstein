...
void ChannelMixingLayer::initialize() {
  ...
  printf("[CM.init] Allocating shift_...\n");
  fflush(stdout);
  shift_.resize(hidden_dim_);
  printf("[CM.init] shift_ allocated, filling values...\n");
  fflush(stdout);
  ...
  printf("[CM.init] prev_shifted_ allocated\n");
  fflush(stdout);
  
  buffer_key_.resize(hidden_dim_, 0.0f);
  printf("[CM.init] buffer_key_ allocated\n");
  fflush(stdout);
  
  buffer_key_act_.resize(hidden_dim_, 0.0f);
  printf("[CM.init] buffer_key_act_ allocated\n");
  fflush(stdout);
  
  buffer_value_.resize(hidden_dim_, 0.0f);
  printf("[CM.init] buffer_value_ allocated\n");
  fflush(stdout);
  
  buffer_gate_.resize(hidden_dim_, 0.0f);
  printf("[CM.init] buffer_gate_ allocated\n");
  fflush(stdout);
