...
export function GetSystemHealth():Promise<Record<string, any>>;
...
export function InvokeAgentChat(arg1:string,arg2:string):Promise<string>;
...
export function SendMessageStream(arg1:string,arg2:string,arg3:string):Promise<void>;
