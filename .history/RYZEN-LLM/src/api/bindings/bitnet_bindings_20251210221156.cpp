...
PYBIND11_MODULE(ryzen_llm_bindings, m)
{
    ...
    printf("DEBUG: All bindings completed successfully\n");

    } catch (const std::exception& e) {
        printf("ERROR in PYBIND11_MODULE: %s\n", e.what());
        throw;
    } catch (...) {
        printf("ERROR in PYBIND11_MODULE: Unknown exception\n");
        throw;
    }
}