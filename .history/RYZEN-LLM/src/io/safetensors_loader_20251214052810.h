...
struct TensorMetadata {
    ...
    static DataType parse_dtype(const std::string& dtype_str) {
        if (dtype_str == "F32" || dtype_str == "float32") return DataType::FLOAT32;
        if (dtype_str == "F16" || dtype_str == "float16") return DataType::FLOAT16;
        if (dtype_str == "I8" || dtype_str == "int8") return DataType::INT8;
        if (dtype_str == "I32" || dtype_str == "int32") return DataType::INT32;
        if (dtype_str == "U8" || dtype_str == "uint8") return DataType::UINT8;
        if (dtype_str == "BF16" || dtype_str == "bfloat16") return DataType::BFLOAT16;
