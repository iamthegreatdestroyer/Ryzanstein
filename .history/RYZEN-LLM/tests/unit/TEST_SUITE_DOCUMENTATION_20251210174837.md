...
*148 comprehensive test cases covering configuration validation, algorithm correctness, numerical stability, and edge cases for the speculative decoding optimization layer.*
