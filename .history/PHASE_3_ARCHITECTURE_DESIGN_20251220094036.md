...
**Week 3-4:** Quantization (Multi-Strategy)
5. Strategy interface + GPTQ
6. AWQ implementation
7. Auto-selector
8. Calibration engine

**Week 5-6:** Long Context
9. Sparse attention patterns
10. KV compression + pruning
11. Segment pooling
12. Streaming attention

**Week 7-8:** Batching + Training
13. Token-level continuous batching
14. LoRA adapter framework
15. Training loop + optimizer
16. LoRA merge utilities

**Week 9-10:** Model Support
17. HuggingFace loader
18. Format converters
19. Architecture mappers
20. GGUF export
