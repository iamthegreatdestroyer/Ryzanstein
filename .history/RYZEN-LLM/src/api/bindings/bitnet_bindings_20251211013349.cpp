...
extern "C" {
    ...
    // Test function for CPU-compatible TernaryWeight constructor
    __declspec(dllexport) int test_ternary_weight_cpu_constructor() {
        try {
            ryzen_llm::bitnet::TernaryWeightCPU weights(4, 4, 0);
    ...
    // Test function for simple CPU-compatible quantization
    __declspec(dllexport) int test_quantize_weights_cpu_simple() {
        try {
            // Create test data
            float test_weights[16] = {1.0f, -2.0f, 3.0f, -4.0f, 5.0f, -6.0f, 7.0f, -8.0f,
                                     9.0f, -10.0f, 11.0f, -12.0f, 13.0f, -14.0f, 15.0f, -16.0f};
            
            ryzen_llm::bitnet::TernaryWeightCPU result = ryzen_llm::bitnet::quantize_weights_ternary_cpu(
                test_weights, 4, 4, ryzen_llm::bitnet::QuantConfig{});
