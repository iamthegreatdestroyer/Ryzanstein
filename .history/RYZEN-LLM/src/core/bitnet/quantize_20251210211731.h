...
namespace ryzen_llm
{
    namespace bitnet
    {
         ...
         *
         * Converts FP32 activations to INT8 with scaling and zero-point for efficient computation.
         * Supports both symmetric and asymmetric quantization modes.
         *
         * @param activations FP32 activation vector
         * @param size Number of elements
         * @param config Quantization configuration
         * @return QuantizedActivation structure
         */
